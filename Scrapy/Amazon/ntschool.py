...
class NtschoolSpider(scrapy.Spider):
    ...
    headers={
        ...
        'Host': 'directory.ntschools.net',
        'Pragma': 'no - cache',
        'Referer': 'https://directory.netschoolst.net/',
        'Sec - Fetch - Dest': 'empty',
        'Sec - Fetch - Mode': 'cors',
        "Sec - Fetch - Site": "same - origin",
        'User - Agent': 'Mozilla / 5.0(Windows NT10.0; Win64;x64) AppleWebKit / 537.36(KHTML, like,Gecko) Chrome / 83.0.4103.116  Safari / 537.36',
        'X - Requested - With': 'Fetch'
        }
