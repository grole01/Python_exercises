...
if __name__ == '__main__':
    freeze_support()
    time_delay = random.uniform(2.05634, 4.15342)
    ...
    class zillow_scraper:
        ...
        def zillow_data(self, url):
            ...
            try:
                ...
                phone_ownername = WebDriverWait(self.browser, 10).until(EC.presence_of_element_located((By.XPATH,'//*[@data-testid="attribution-agent"]' or '//*[@id="ds-data-view"]/ul/li[3]/div[2]/div/div/div[2]/div[1]/div[4]/div/span[2]/p[1]'))).text
            ...
            try:
                adress = WebDriverWait(self.browser, 10).until(EC.presence_of_element_located((By.XPATH,    '//*[@id="ds-chip-property-address"]/span[1]'
                                                                                               or '//*[@id="home-details-content"]/div/div/div[1]/div[2]/div[2]/div[1]/div/div[1]/div/div/div[2]/h1'
                                                                                               or '//*[@id="home-details-content"]/div/div/div[1]/div[2]/div[2]/div[1]/div/div[1]/div/div/div[2]/h1'
                                                                                               or '(//h1[@id="ds-chip-property-address"]//span)[3]'
                                                                                               or '(//*[@id="ds-chip-property-address"]/span[1])[1]'
                                                                                               or "(//h1[@id='ds-chip-property-address'])[2]"))).text
                ...
                state1 = WebDriverWait(self.browser, 10).until(EC.presence_of_element_located(
                    (By.XPATH, '//*[@id="ds-chip-property-address"]/span[2]'))).text  # /text()[2]
                print(state1)
                state1 = state1.split(",")
                city = state1[0].strip()
                print(city)
                ...
                adress = WebDriverWait(self.browser, 10).until(EC.presence_of_element_located((By.XPATH,'//*[@id="ds-chip-property-address"]/span[1]' or '//*[@id="home-details-content"]/div/div/div[1]/div[2]/div[2]/div[1]/div/div[1]/div/div/div[2]/h1'or"(//h1[@id='ds-chip-property-address'])[2]"))).text
                adress = ""
                street = ""
                city = ''
                state = ""
            ...
            # description
            try:
                description = WebDriverWait(self.browser, 10).until(EC.presence_of_element_located((By.XPATH,  "//div[@class='sc-iAKWXU jZFFKP']//div[1]"
                                                                                                    or '//*[@id="ds-data-view"]/ul/li[3]/div[2]/div/div/div[2]/div[1]/div[3]/div[1]/div'
                                                                                                    ...
                                                                                                    or "//div[@class='Text-c11n-8-63-0__sc-aiai24-0 sc-caiLqq gbKiss cnCyKR']"
            ...
            try:
                timeonzillow = WebDriverWait(self.browser, 10).until(EC.presence_of_element_located((By.XPATH,  "(//div[@class='Text-c11n-8-63-0__sc-aiai24-0 kHCdln'])[1]"or '//*[@id="ds-data-view"]/ul/li[3]/div[2]/div/div/div[2]/div[1]/div[2]/div[1]/div[2]' or '//div[@clas="Text-c11n-8-63-0__sc-aiai24-0 sc-caiLqq gbKiss cnCyKR"]' or"(//div[@class='Text-c11n-8-63-0__sc-aiai24-0 ixzvGO']/following-sibling::div)[1]"))).text
                print(timeonzillow)
                try:
            ...
            self.WriteDataToExcel(url, ownername, phone_no, street, city, state, description, price, timeonzillow,
