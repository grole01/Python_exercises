...
if __name__ == '__main__':
    ...
    class zillow_scraper:
        ...
        browser = webdriver.Chrome(service=Service(ChromeDriverManager().install()),
                                   options=options, seleniumwire_options=proxy_options)#,desired_capabilities=caps,)
        ...
        def zillow_data(self, url):
            ...
            try:
                phone_ownername = WebDriverWait(self.browser, 10).until(EC.presence_of_element_located((By.XPATH,
                                                                                                        '//*[@data-testid="attribution-agent"] | //*[@id="ds-data-view"]/ul/li[3]/div[2]/div/div/div[2]/div[1]/div[4]/div/span[2]/p[1]'))).text
        ...
        def WriteDataToExcel(self, url, ownername, phone_no, street, city, state, description, price, Sold,
                             timeonzillow,
                             zestimate, rentzestimate):
            # , rentzestimate
            Data_Dict = {
        ...
        def getting_urls(self, url):
            ...
            while True:
                ...
                element_1 = WebDriverWait(self.browser, 10).until(
                    EC.presence_of_element_located((By.XPATH, "//button[@alt='Switch to Other listings']")))
                # self.browser.execute_script("arguments[0].click();", element_1)
                ...
                get_article = WebDriverWait(self.browser, 10).until(EC.presence_of_all_elements_located(
                    (By.XPATH, "//*[@class='list-card-link list-card-link-top-margin list-card-img']"
                ...
                next_button = WebDriverWait(self.browser, 10).until(EC.presence_of_element_located(
                    (By.XPATH, '//*[@id="grid-search-results"]/div[3]/nav/ul/li[5]/a | //a[@title="Next page"]'
        ...
        def connector(self, url):
            time_delay = random.uniform(1.05634, 2.5342)
            ...
            for url in urls:
                ...
                time.sleep(5)
                # log
                print("Property Scraped : " + str(i) + " out of " + str(len(urls)) + " remaining urls : " + str(
                    len(urls) - i))
